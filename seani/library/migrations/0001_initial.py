    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer2', models.CharField(max_length=200, verbose_name='Respuesta A')),
                ('answer1', models.CharField(max_length=200, verbose_name='Respuesta B')),
                ('answer3', models.CharField(max_length=200, verbose_name='Respuesta C, null=True')),
                ('answer4', models.CharField(max_length=200, verbose_name='Respuesta D, null=True')),
